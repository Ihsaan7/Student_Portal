      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === 'general' ? (
          <div className="bg-white rounded-lg shadow">
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <input
                  type="text"
                  value={settings.system_name || 'VU Clone Admin'}
              ...
              <div>
                <label className="flex items-center">
                  <input
                    ...
                    onChange={(e) => handleSettingChange('allow_user_registration', e.target.checked.toString())}
                    className="mr-2"
                  />
          ...
          <div className="bg-white rounded-lg shadow">
            ...
            <div className="p-6">
              {logs.length === 0 ? (
                <p className="text-gray-500 text-center py-4">No admin logs found</p>
              ) : (
                    ...
                    <div key={index} className="flex items-start space-x-3 p-3 bg-gray-50 rounded">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600">
                          Action: <span className="font-medium">{log.action.replace('_', ' ')}</span>
                        </p>
                        {log.target_type && (
                          <p className="text-xs text-gray-500">
